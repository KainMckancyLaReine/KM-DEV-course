...
window.KMT = (function () {
  ...
  var DICT = {
    ...
    'Start building with AI.': 'Begin met bouwen met AI.',
    'Create your KM.dev account and start learning how to build real websites with Claude.':
      'Maak je KM.dev-account aan en leer echte websites bouwen met Claude.',
    'Your name': 'Je naam',
    'At least 8 characters': 'Minstens 8 tekens',
    'Repeat it': 'Herhaal het',
    ...
    'Enter the address on your account and a reset link will be sent to it.':
      'Vul het adres van je account in; je krijgt er een herstellink op.',
    'Send reset link': 'Stuur herstellink',
    'Remembered it?': 'Weet je hem weer?',
    'From your first prompt to your first complete website.':
      'Van je eerste prompt tot je eerste complete website.',
    'Eight levels. One project. A site that is actually online at the end.':
      'Acht levels. \u00c9\u00e9n project. Een site die aan het eind echt online staat.',
    'Nothing about your password is ever stored in this website\u2019s code.':
      'Er wordt nooit iets over je wachtwoord bewaard in de code van deze website.',
    'Think \u2014 decide what you are building': 'Denken \u2014 bepaal wat je bouwt',
    'Prompt \u2014 learn to direct a model': 'Prompten \u2014 leer een model aansturen',
    'Build \u2014 turn instructions into code': 'Bouwen \u2014 maak van instructies code',
    'Ship \u2014 put it online under your name': 'Opleveren \u2014 zet het online onder je eigen naam',
